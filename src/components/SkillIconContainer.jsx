...
function SkillIconContainer() {
  return (
    <div className="skillContainer d-flex flex-wrap justify-content-around">
      <LogoContainer id="react" sec={3} isFillPath color="rgba(97, 218, 251, 1)" Logo={<ReactLogo />} content="React.js" />
      <LogoContainer id="styleJsx" sec={1} isFillPath color="rgba(255, 255, 255, 0.5)" Logo={<StyleJsxLogo />} content="Style Jsx" />
      <LogoContainer id="reactRouter" sec={1.5} color="rgba(86, 216, 249, 1)" Logo={<ReactRouterLogo />} content="React Router" />
      <LogoContainer id="bootstrap" sec={1.5} isFillPath color="rgba(226, 177, 255, 101)" Logo={<BootstrapLogo />} content="Bootstrap 4" />
      <LogoContainer id="javascript" sec={1.5} isFillPath color="rgba(241, 218, 31, 0.6)" Logo={<JavascriptLogo />} content="Javascript" />
